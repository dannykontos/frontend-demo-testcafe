...
export interface UI5DataResult {
    /**
...
export interface UI5SelectorDef extends Selector {
    getUI5(fn?: UI5DataCallback): Promise<UI5DataResult>;
}
export declare type UI5DataCallback = (element: UI5SelectorDef) => any;
export declare let UI5Selector: (timeout?: number | undefined) => UI5SelectorDef;
export {};
